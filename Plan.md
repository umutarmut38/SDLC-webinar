...
- [ ] Protected, separately authorized deployed-asset cleanup workflow exists on `main`.
...
| 2026-07-16 | Restrict post-demo cleanup to artifacts uploaded by `/deploy`; retain infrastructure     | In progress      |
